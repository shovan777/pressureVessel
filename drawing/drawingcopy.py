...
#         surface.set_document_unit(4)
    ...
    def draw_ellipse(self, centerX, centerY, headScale1, headScale2, diameter, flip, orientation, line_width=2, colorRed=0, colorGreen=0, colorBlue=0, colorAlpha=1):
        ...
        if orientation:
            ...
            if flip:
                self.cr.arc_negative(centerX+diameter/2, (headScale2/headScale1)*centerY, diameter/2, 0, math.pi)
            else :
                self.cr.arc(centerX+diameter/2, (headScale2/headScale1)*centerY, diameter/2, 0, math.pi)
            self.cr.stroke()
            self.cr.scale(1,headScale2/headScale1)
        else:
            self.cr.scale(headScale1/headScale2,1)
            if flip:
                self.cr.arc_negative((headScale2/headScale1)*centerX, centerY+diameter/2, diameter/2, math.pi/2, 3*math.pi/2)
            else :
                self.cr.arc((headScale2/headScale1)*centerX, centerY+diameter/2, diameter/2, math.pi/2, 3*math.pi/2)
            self.cr.stroke()
    ...
    def arrange_data (self,data):
        ...
        length_of_bottom_head = 0
        length_of_top_head =0
        total_length = 0
        ...
        return main_array,length_of_bottom_head,length_of_top_head,total_length
