...
class SchemaDeleteTest(TestCase):

    def setUp(self):
        self.url = reverse('schema-delete')
    ...
    def tearDown(self):
        shutil.rmtree(settings.STATIC_ROOT+"/states/user_john/7", ignore_errors=True)
        shutil.rmtree(settings.STATIC_ROOT+"/states/user_john/8", ignore_errors=True)
        shutil.rmtree(settings.STATIC_ROOT+"/states/user_john/9", ignore_errors=True)

    def test_schema_delete_without_authorization_token(self):
        data_report = {
            "report_type":"vessel",
            "projectName":"7",
    ...
    def test_schema_delete_with_authorization_token(self):
        data_report = {
            "report_type":"vessel",
            "projectName":"8",
            "orientation":"vertical"
        ...
        self.assertEqual(b'deleted', response.content)

    def test_schema_delete_without_projectid(self):
        data_report = {
            "report_type":"vessel",
            "projectName":"9",
            "orientation":"vertical"
